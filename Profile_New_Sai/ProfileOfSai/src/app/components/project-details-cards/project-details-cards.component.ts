...
@Component({
  selector: 'project-details-cards',
  templateUrl: './project-details-cards.component.html',
  styleUrls: ['./project-details-cards.component.css'],
})
export class ProjectDetailsCardsComponent implements OnInit {
  constructor() {}
  ...
  projectDetails: any = [
    ...
    },
    {
      ...
      languagesAndToolsUsed: ['HTML5', ' CSS', 'Angular JS', 'jQuery','Javascript'],
      idesAndOtherToolsUsed: [
        { tool: 'WebStorm', priority: 'high' },
        { tool: 'Android Studio', priority: 'high' },
        { tool: 'Xcode', priority: 'high' },
    ...
    },
    {
      ...
      platformsUsed: [
        'iPhone and iPad devices', 'Windows System', 'Mobile Devices - Android',
      ],
      languagesAndToolsUsed: ['C#', 'Objective C', 'HTML', 'CSS', 'JavaScript', 'JQuery'
      ],
      idesAndOtherToolsUsed: [
